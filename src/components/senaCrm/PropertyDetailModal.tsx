        ...
        <div className="p-6 space-y-6 max-h-[60vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            {property.rentalPrice && (
              <div className="p-3 bg-slate-950 rounded-2xl border border-slate-800 space-y-0.5">
                <span className="text-[10px] text-slate-400 font-bold uppercase">Locação Mensal</span>
            ...
            <div className="p-3 bg-slate-950 rounded-2xl border border-slate-800 space-y-0.5">
              <span className="text-[10px] text-slate-400 font-bold uppercase">Área Total / Privativa</span>
            ...
            <div className="p-3 bg-slate-950 rounded-2xl border border-slate-800 space-y-0.5">
              <span className="text-[10px] text-slate-400 font-bold uppercase">Dormitórios & Vagas</span>
              <p className="text-sm font-black text-white">
