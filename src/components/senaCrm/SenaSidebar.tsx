  ...
  const navSections = [
    {
      title: "VISÃO GERAL",
      items: [
        { id: "dashboard" as SenaTab, label: "Dashboard Executivo", icon: LayoutDashboard, badge: "2026" },
      ],
    },
    {
      title: "COMERCIAL",
      items: [
        ...
        { id: "funil" as SenaTab, label: "Funil de Vendas (Kanban)", icon: GitPullRequest, badge: "Ativo" },
        ...
        { id: "propostas" as SenaTab, label: "Propostas & Negociações", icon: FileSpreadsheet, count: 2 },
      ],
    },
    {
      title: "IMÓVEIS",
      items: [
        ...
        { id: "vendas" as SenaTab, label: "Fechamentos de Venda", icon: CheckCircle2, badge: "Vendido" },
      ],
    },
    {
      title: "LOCAÇÕES",
      items: [
        { id: "locacoes-contratos" as SenaTab, label: "Contratos Administrados", icon: KeyRound, count: 4 },
        { id: "locacoes-repasses" as SenaTab, label: "Recebimentos & Repasses", icon: ArrowRightLeft },
        { id: "locacoes-vistorias" as SenaTab, label: "Vistorias Técnicas", icon: ClipboardCheck },
        { id: "locacoes-manutencoes" as SenaTab, label: "Manutenções & Reparos", icon: Wrench, badge: "1 pend." },
      ],
    },
    {
      title: "LOTEAMENTOS & URBANISMO",
      items: [
        { id: "loteamentos-empreendimentos" as SenaTab, label: "Empreendimentos", icon: Trees, count: 2 },
        { id: "loteamentos-espelho" as SenaTab, label: "Espelho de Vendas Visual", icon: Grid3X3, badge: "Mapa" },
        { id: "loteamentos-simulador" as SenaTab, label: "Simulador de Parcelas", icon: Calculator },
    ...
    },
    {
      ...
      items: [
        { id: "equipe-corretores" as SenaTab, label: "Corretores & Desempenho", icon: Award, count: 5 },
        { id: "equipe-comissoes" as SenaTab, label: "Cálculo de Comissões", icon: DollarSign },
        { id: "equipe-ranking" as SenaTab, label: "Ranking Comercial", icon: Trophy, badge: "Top 1" },
      ],
    },
    {
      title: "SISTEMA",
      items: [
        ...
        { id: "sistema-configuracoes" as SenaTab, label: "Configurações da Unidade", icon: Settings },
      ],
    },
  ];
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 font-medium">Imóveis • Locações • Loteamentos</p>
              </div>
            </div>
          </div>
        ...
        <div className="p-3 border-t border-slate-800/80 bg-slate-950/40">
          <div className="flex items-center gap-3 p-2 rounded-lg bg-slate-850/60 border border-slate-800">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[10px] text-amber-400 font-medium truncate">Diretor Geral • CRECI-SP</p>
            </div>
          </div>
        </div>
      </aside>
