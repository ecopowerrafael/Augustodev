...
export interface Visit {
  ...
  feedback?: string;
  clientImpression?: "Adorou / Fará Proposta" | "Gostou mas achou caro" | "Imóvel pequeno" | "Localização desfavorável" | "Sem interesse";
}
...
export interface Proposal {
  ...
  status: "Em Análise" | "Aceita pelo Proprietário" | "Contraproposta Enviada" | "Recusada" | "Convertida em Venda";
  createdAt: string;
  updatedAt: string;
...
export interface SaleClosure {
  ...
  saleDate: string;
  paymentType: "Financiamento Bancário" | "À Vista TED/PIX" | "Parcelamento Direto" | "Permuta + Saldo";
...
export interface RentalContract {
  ...
  endDate: string;
  dueDay: number;
  guaranteeType: "Seguro Fiança (Porto Seguro)" | "CredPago" | "Fiador com Imóvel" | "Título de Capitalização" | "Depósito Caução";
...
export interface RentalPayout {
  ...
  status: "Aguardando Recebimento" | "Recebido do Locatário" | "Repassado ao Proprietário" | "Em Atraso";
}
...
export type LotStatus = "Disponivel" | "Reservado" | "Em Proposta" | "Vendido" | "Bloqueado" | "Distrato";
